 ...
 * Created by zac
 */
public class SubtreeSwapMutationOperator implements IMutationOperator {

    private TreeFactory treeFactory;
    private final int maxDepth;

    public SubtreeSwapMutationOperator(TreeFactory treeFactory, int maxDepth) {
...
//        if (tree.getDepth() > treeFactory.maxDepth || tree.getNodeCount() > treeFactory.maxNodeCount){
